...
public class ModPotions {
	...
	public static final RegistryObject<Potion> MIGHTY_LEAPING = POTIONS.register("mighty_leaping", () -> new Potion(new EffectInstance(Effects.JUMP, 4800, 1)));
	...
	public static final RegistryObject<Potion> MIGHTY_SWIFTNESS = POTIONS.register("mighty_swiftness", () -> new Potion(new EffectInstance(Effects.MOVEMENT_SPEED, 4800, 1)));
	public static final RegistryObject<Potion> MIGHTY_TURTLE_MASTER = POTIONS.register("mighty_turtle_master", () -> new Potion(new EffectInstance(Effects.MOVEMENT_SLOWDOWN, 1060, 5), new EffectInstance(Effects.DAMAGE_RESISTANCE, 1060, 3)));
	...
	public static final RegistryObject<Potion> MIGHTY_HEALING = POTIONS.register("mighty_healing", () -> new Potion(new EffectInstance(Effects.HEAL, 1, 2)));
	...
	public static final RegistryObject<Potion> MIGHTY_STRENGTH = POTIONS.register("mighty_strength", () -> new Potion(new EffectInstance(Effects.DAMAGE_BOOST, 4800, 1)));
	...
	public static void onPotionTypeRegistry(RegistryEvent.Register<Potion> event) {
		if (ModList.get().isLoaded(WTImprovements.QUARK_ID)) {
			...
			MIGHTY_FORTITUDE = new Potion(new EffectInstance(Effects.DAMAGE_RESISTANCE, 4800, 1)).setRegistryName("mighty_fortitude");
